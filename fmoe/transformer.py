...
class FMoETransformerMLP(FMoE):
    ...
    * `d_hidden` is the dimension of the MLP layer.
    ...
    def forward(self, inp: torch.Tensor, layer_idx = 0,  training_step=0, fuse_token=False, is_zero=0,is_eval=False,epoch=0,eval_idx=0,eval_num=0,num_eval_subset=0,train_batch_size=0):
        r"""
        ...
        output, fusion_costs, comm_time, traffic_size = super().forward(inp, original_shape, self.total_experts, self.top_k, 
                                                                        ...
                                                                        is_zero=is_zero,is_eval=is_eval,epoch=epoch,eval_idx=eval_idx,eval_num=eval_num,num_eval_subset=num_eval_subset,train_batch_size=train_batch_size)
