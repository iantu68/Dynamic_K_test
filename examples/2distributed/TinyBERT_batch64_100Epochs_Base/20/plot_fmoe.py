...
for i in range(8):
    ...
    # 对每个值进行斜率計算
    values1_avg_slopes_avg = calculate_avg_steps(values1_avg_slopes)
    values2_avg_slopes_avg = calculate_avg_steps(values2_avg_slopes)
    values3_avg_slopes_avg = calculate_avg_steps(values3_avg_slopes)
    values4_avg_slopes_avg = calculate_avg_steps(values4_avg_slopes)
    ...
    plt.figure()
    plt.plot(values1_avg_slopes_avg , label='L0_FFN0_na_slope_avg', color='red')
    plt.plot(values2_avg_slopes_avg , label='L0_FFN1_na_slope_avg', color='blue')
    plt.title(f'L0_grads_Slopes_avg')
    plt.xlabel('Epoch')
    plt.ylabel('Slope')
    plt.legend()
    plt.grid(True)
    plt.savefig(f'L0_grads_Slopes{i}_avg.png')
    plt.show()

    plt.figure()
    plt.plot(values3_avg_slopes_avg , label='L1_FFN0_na_slope_avg', color='red')
    plt.plot(values4_avg_slopes_avg , label='L1_FFN1_na_slope_avg', color='blue')
    plt.title(f'L1_grads_Slopes_avg')
    plt.xlabel('Epoch')
    plt.ylabel('Slope')
    plt.legend()
    plt.grid(True)
    plt.savefig(f'L1_grads_Slopes{i}_avg.png')
    plt.show()