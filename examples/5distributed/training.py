    ...
    try:
        for epoch in range(num_epochs):
            ...
            for batch in train_dataloader:
                ...
                print(f"Epoch {epoch} | Loss {loss_all/step:.2f} | acc {accuracy:.2f} | time {end_time:.2f} | max_acc {max_acc:.2f} |")
            ...
            acc.append(accuracy)
            if accuracy > max_acc:  # Update max_acc
                max_acc = accuracy
            print(f"Epoch {epoch} | Loss {loss_all/step:.2f} | acc {accuracy:.2f} | max_acc {max_acc:.2f} |===============")
