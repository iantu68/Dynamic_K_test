...
#     linear_avg_value = np.load(f"FFN0_grads_Avg_{i}.npy", allow_pickle=True)
...
#     # values8 = np.load(f"expert_grads_L3_FFN1_{i}_nabs.npy", allow_pickle=True)
    ...
    # plt.figure()
    # plt.plot(values1, label='L0_Liner0_na', color='red', linestyle='-')
    # plt.plot(values2, label='L0_Liner1_na', color='blue', linestyle='-')
    # plt.legend(loc='upper right')
    ...
    # plt.figure()
    # plt.plot(values3, label='L1_Liner0_na', color='red', linestyle='-')
    # plt.plot(values4, label='L1_Liner1_na', color='blue', linestyle='-')
    # plt.legend(loc='upper right')
    ...
    # #Plot linear Avg 
    # plt.figure()
    # plt.plot(linear_avg_value, label='Avg_Liner', color='red', linestyle='-')
    # plt.legend(loc='upper right')
    # plt.title(f'avg_grads_values')
    # plt.xlabel('Epoch')
    # plt.ylabel('Gradients Value')
    # plt.ylim()
    # plt.savefig(f'avg_grads_values{i}.png')
    # plt.show()